...
@Component({
  selector: 'app-daily-summary-scrutiny-lmv',
  templateUrl: './daily-summary-scrutiny-lmv.component.html',
  styleUrls: ['./daily-summary-scrutiny-lmv.component.css']
})
export class DailySummaryScrutinyLmvComponent implements OnInit {
