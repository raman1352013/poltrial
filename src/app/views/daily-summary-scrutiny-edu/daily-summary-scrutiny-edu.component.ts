...
@Component({
  selector: 'app-daily-summary-scrutiny-edu',
  templateUrl: './daily-summary-scrutiny-edu.component.html',
  styleUrls: ['./daily-summary-scrutiny-edu.component.css']
})
export class DailySummaryScrutinyEduComponent implements OnInit {
