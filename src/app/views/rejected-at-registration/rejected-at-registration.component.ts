...
@Component({
  selector: 'app-rejected-at-registration',
  templateUrl: './rejected-at-registration.component.html',
  styleUrls: ['./rejected-at-registration.component.css']
})
export class RejectedAtRegistrationComponent implements OnInit {
