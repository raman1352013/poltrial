...
@Component({
  selector: 'app-absent-after-registration',
  templateUrl: './absent-after-registration.component.html',
  styleUrls: ['./absent-after-registration.component.css']
})
export class AbsentAfterRegistrationComponent implements OnInit {
