...
@Component({
  selector: 'app-allow-provisioned',
  templateUrl: './allow-provisioned.component.html',
  styleUrls: ['./allow-provisioned.component.css']
})
export class AllowProvisionedComponent implements OnInit {
