...
@Component({
  selector: 'app-daily-summary-scrutiny-nss',
  templateUrl: './daily-summary-scrutiny-nss.component.html',
  styleUrls: ['./daily-summary-scrutiny-nss.component.css']
})
export class DailySummaryScrutinyNssComponent implements OnInit {
