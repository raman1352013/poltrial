...
@Component({
  selector: 'app-daily-summary-scrutiny',
  templateUrl: './daily-summary-scrutiny.component.html',
  styleUrls: ['./daily-summary-scrutiny.component.css']
})
export class DailySummaryScrutinyComponent implements OnInit {
