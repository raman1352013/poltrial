...
@Component({
  selector: 'app-rejected-after-registration',
  templateUrl: './rejected-after-registration.component.html',
  styleUrls: ['./rejected-after-registration.component.css']
})
export class RejectedAfterRegistrationComponent implements OnInit {
