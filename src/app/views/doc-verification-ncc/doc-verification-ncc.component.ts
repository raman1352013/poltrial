...
@Component({
  selector: 'app-doc-verification-ncc',
  templateUrl: './doc-verification-ncc.component.html',
  styleUrls: ['./doc-verification-ncc.component.css']
})
export class DocVerificationNccComponent implements OnInit {
  ...
  submitApplicationForm: boolean = false;
  constructor(
  ...
  getApplicationSubmitted(application) {
    this.generateAdmitCardForm.controls['nssEvaluation'].setValue('0')
    this.generateAdmitCardForm.controls['nccEvaluation'].setValue('0')
    this.generateAdmitCardForm.controls['scoutEvaluation'].setValue('0')
    this.generateAdmitCardForm.controls['isSports'].setValue('0')
    this.generateAdmitCardForm.controls['isMdw'].setValue('0')

    this.generateAdmitCardForm.controls['nssEvaluationMarks'].setValue('0')
    this.generateAdmitCardForm.controls['nccEvaluationMarks'].setValue('0')
    this.generateAdmitCardForm.controls['scoutEvaluationMarks'].setValue('0')
    this.generateAdmitCardForm.controls['nssNccEvaluationMarks'].setValue('0')
    this.generateAdmitCardForm.controls['sportsEvaluationMarks'].setValue('0')
    this.generateAdmitCardForm.controls['mdwEvaluationMarks'].setValue('0')


    this.enableScanner = false;
    this.applicationService.getApplicationScrutiny(application, 5).then((resp: any) => {
      if (resp.status == 200) {
  ...
  selectIsSports() {
    const isSports = this.generateAdmitCardForm.controls['isSports'].value;
    console.log('isSports ' , isSports)
    this.generateAdmitCardForm.controls['sportsEvaluationMarks'].setValue(isSports)
    // if(isSports == 0) {
  ...
  selectNss() {
    const isSports = this.generateAdmitCardForm.controls['nssEvaluation'].value;
    console.log('isSports ' , isSports)
    this.generateAdmitCardForm.controls['nssEvaluationMarks'].setValue(isSports)
    let totalMarks = 0;
    totalMarks =  Number(this.generateAdmitCardForm.controls['nssEvaluationMarks'].value || 0) + Number(this.generateAdmitCardForm.controls['nccEvaluationMarks'].value || 0) + Number(this.generateAdmitCardForm.controls['scoutEvaluationMarks'].value || 0) 
    if(totalMarks > 4) {
      this.generateAdmitCardForm.controls['nssNccEvaluationMarks'].setValue(4)
    } else {
      this.generateAdmitCardForm.controls['nssNccEvaluationMarks'].setValue(totalMarks)
    }
  }

  selectNcc() {
    const isSports = this.generateAdmitCardForm.controls['nccEvaluation'].value;
    console.log('isSports ' , isSports)
    this.generateAdmitCardForm.controls['nccEvaluationMarks'].setValue(isSports)
    let totalMarks = 0;
    totalMarks =  Number(this.generateAdmitCardForm.controls['nssEvaluationMarks'].value || 0) + Number(this.generateAdmitCardForm.controls['nccEvaluationMarks'].value || 0) + Number(this.generateAdmitCardForm.controls['scoutEvaluationMarks'].value || 0) 
    if(totalMarks > 4) {
      this.generateAdmitCardForm.controls['nssNccEvaluationMarks'].setValue(4)
  ...
  selectIsScout() {
    const isSports = this.generateAdmitCardForm.controls['scoutEvaluation'].value;
    console.log('isSports ' , isSports)
    this.generateAdmitCardForm.controls['scoutEvaluationMarks'].setValue(isSports)
  ...
  medalWinner() {
    const isMdw = this.generateAdmitCardForm.controls['isMdw'].value;
    this.generateAdmitCardForm.controls['mdwEvaluationMarks'].setValue(isMdw)
  }
  ...
  scoutMarks() {
    // let nssNccEvaluationMarks;
    // if(this.generateAdmitCardForm.controls['nssNccEvaluationMarks'].value > -1 && this.generateAdmitCardForm.controls['nssNccEvaluationMarks'].value < 5) {
    //   nssNccEvaluationMarks = 'Y'
    // } else {
    //   this.sharedService.showWarning('Please enter value between 0-4')
    //   nssNccEvaluationMarks = 'N';
    //   this.generateAdmitCardForm.controls['nssNccEvaluationMarks'].setValue('');
    // }
  }
  ...
  submitApplication() {
    ...
    let isSports;
    if(this.generateAdmitCardForm.controls['isSports'].value != 0) {
      isSports = 'Y'
    } else {
      isSports = 'N'
    }
    ...
    let isMdw;
    if(this.generateAdmitCardForm.controls['isMdw'].value == 1) {
      isMdw = 'Y'
    } else {
      isMdw = 'N'
    }

    for (let el in this.generateAdmitCardForm.controls) {
      if (this.generateAdmitCardForm.controls[el].errors) {
        console.log(el)
      }
 }  
    ...
    const reqObj = {
      ...
      isNssNcc: 'Y',
      nssNccEvaluationMarks: this.generateAdmitCardForm.controls['nssNccEvaluationMarks'].value,
      nssNccRemarks: this.generateAdmitCardForm.controls['nssNccRemarks'].value,
      isSports: isSports,
      sportsEvaluationMarks: this.generateAdmitCardForm.controls['isSports'].value,
      sportsRemarks: '',
      isMdw: isMdw,
      mdwEvaluationMarks: this.generateAdmitCardForm.controls['mdwEvaluationMarks'].value,
      mdwRemarks: null,
      nssNccStr: 'nss-'+ this.generateAdmitCardForm.controls['nssEvaluationMarks'].value + '|ncc-' +  this.generateAdmitCardForm.controls['nccEvaluationMarks'].value + '|bscout-' +  this.generateAdmitCardForm.controls['scoutEvaluationMarks'].value,
      mode: 'SCR'
    }
    console.log('Reqobj ', reqObj)
