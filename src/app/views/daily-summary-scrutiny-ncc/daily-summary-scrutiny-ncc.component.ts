...
@Component({
  selector: 'app-daily-summary-scrutiny-ncc',
  templateUrl: './daily-summary-scrutiny-ncc.component.html',
  styleUrls: ['./daily-summary-scrutiny-ncc.component.css']
})
export class DailySummaryScrutinyNccComponent implements OnInit {
