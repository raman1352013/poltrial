...
@Component({
  selector: 'app-doc-verification-download-result',
  templateUrl: './doc-verification-download-result.component.html',
  styleUrls: ['./doc-verification-download-result.component.css']
})
export class DocVerificationDownloadResultComponent implements OnInit {
  ...
  downloadReport() { 
    const reqObj = {
      ...
      categoryId: this.searchForm.controls['category'].value || null,
      subCategoryId: this.searchForm.controls['subCategory'].value || null,
      gender: this.searchForm.controls['gender'].value || null,
      postApplied: this.searchForm.controls['postApplied'].value || null,
    }
